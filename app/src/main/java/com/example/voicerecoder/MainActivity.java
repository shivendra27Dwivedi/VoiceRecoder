...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void stopPlaying() {
        ...
        imageViewPlay.setImageResource(R.drawable.ic_baseline_play_circle_outline_24);
        chronometer.stop();
    ...
    private void startRecording() {
        ...
        fileName = root.getAbsolutePath() + "/VoiceRecorderSimplifiedCoding/Audios/" + System.currentTimeMillis() + ".mp3";
    ...
    private void startPlaying() {
        ...
        imageViewPlay.setImageResource(R.drawable.ic_baseline_pause_circle_outline_24);
